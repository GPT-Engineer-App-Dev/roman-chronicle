...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-red-100">
      ...
      <header className="bg-pink-300 py-8 px-4 md:px-8 lg:px-16">
        <div className="container mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-red-900">The Glory of Rome</h1>
          <p className="text-xl md:text-2xl lg:text-3xl text-red-800">Explore the Grandeur of the Ancient Empire</p>
        </div>
      </header>
